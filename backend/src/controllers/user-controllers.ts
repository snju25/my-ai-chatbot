...
export const userSignup = async  (req: Request,res:Response,next:NextFunction) =>{
    ...
    try {
        ...
        await user.save()
         // clear cookies
         res.clearCookie("auth_token", {httpOnly: true, domain: "my-ai-chatbot-production-sanjay.up.railway.app", signed: true, path: "/"}); //clear any existing cookies
         ...
         res.cookie("auth_token", token, {path: "/", domain: "my-ai-chatbot-production-sanjay.up.railway.app" , expires, httpOnly: true, signed: true});
